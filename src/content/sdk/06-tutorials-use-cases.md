...
summary: "Agent identity verification, P2P trust establishment, and automated settlement workflows."
date: 2025-01-14
tags: ["sdk", "tutorials", "use-cases", "identity", "settlement", "workflows"]
draft: false
---
...
```json
{
  ...
  "references": [
    ...
    "https://docs.vchat.email/tutorials/settlement",
    "https://docs.vchat.email/tutorials/workflows"
  ],
  "tools": [
    "VGate SDK",
    "VGate CLI",
